...
import style from './styleFuncionario';
import Funcoes from './Funcoes';


function FormCFuncionario({ navigation, setModo }) {

    const { Teclado, LogarFuncionario, Erro, setErro, Usuario, setUsuario, Senha, setSenha } = Funcoes({ navigation });

    return (
        <View style={style.Container}>
            <StatusBar backgroundColor={Configs.ColorWhite} barStyle="default" />
            ...
            <View style={style.Session2}>
                ...
                <View style={style.Input}>
                    ...
                    <TextInput value={Usuario} onChangeText={(e) => setUsuario(e)} autoCapitalize={false} autoCorrect={false} style={style.TextInput} placeholder="Usuário" placeholderTextColor={Configs.ColorGray200} />
                </View>
            ...
            <View style={style.Session3}>
                ...
                <TouchableOpacity onPress={LogarFuncionario} style={style.BtnEntrar}>
            ...
            <Dialog visible={Erro} dismissable={false} style={{ borderRadius: 5 }}>
                ...
                <Dialog.Content>
                    <Text variant="bodyMedium">Erro autenticação !</Text>
                </Dialog.Content>
                <Dialog.Actions>
                    <Button onPress={() => setErro(false)}>Tentar Novamente</Button>
                </Dialog.Actions>
            </Dialog>
...
export default FormCFuncionario;